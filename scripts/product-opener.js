const foodNames = ["Argular Salad", "Noodle Egg Vegie", "Potato Quinoa Patties", "Hot Shakshuka"]

const ingredients = ["Green Apple, Goat Cheese", "Salmon, Eggs, Chinese Noodles", "Potatoes, Salmon", "Eggs, Tomatoes"]
